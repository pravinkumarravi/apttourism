...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        ...
                        <li ><a href="<?php echo url('/') ?>">Home</a></li>
                            <li class="active"><a href="<?php echo url('Tirupati_Packages') ?>">Tirupati Packages</a></li>
    ...
    <!-- Tirupati package start -->

    <div class="container justify-content-center text-center"><br><br><br>
        <h3>SELECT YOUR PACKAGES</h3><br><br>
        <div class="row">
            <div class="col options">
                <h4>Tirupathi tour package</h4><br>
                <p>The package includes morning Breakfast, Afternoon Lunch , car rental for one day, Darshan tickets,Driver bata, tollgate, Permit, Parking, Doorstep pickup and dropThe package includes morning Breakfast, Afternoon Lunch , car rental for one day, Darshan tickets,Driver bata, tollgate, Permit, Parking, Doorstep pickup and drop</p>
                <p>Special Arrangements for NRI, Baby Below one year and Senior Citizen (65 and above).</p><br>
                <a href="<?php echo url('tirupathi')?>"><button class="btn btn-danger text-white">select</button></a>
            </div>
            <div class="col options">
                <h4>Kalahasti tour package</h4><br>
                <p>The package includes morning Breakfast, Afternoon Lunch , car rental for one day, Darshan tickets,Driver bata, tollgate, Permit, Parking, Doorstep pickup and dropThe package includes morning Breakfast, Afternoon Lunch , car rental for one day, Darshan tickets,Driver bata, tollgate, Permit, Parking, Doorstep pickup and drop</p>
                <p>Special Arrangements for NRI, Baby Below one year and Senior Citizen (65 and above).</p><br>
                <a href="<?php echo url('tirupathi')?>"><button class="btn btn-danger text-white">select</button></a>
            </div>

...
<body>
    ...
    <div class="container justify-content-center">
        <h4 class="text-center">PROGRAM DETAILS</h4><br><br>
        <div class="row">
            <div class="col">
                <div class="star" style="font-size: 17px;">
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Breakfast and Lunch</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;RS. 300/- Tirupati Special Entry Darshan Tickets (Seegra Darshan Ticket)</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Each Person 01 - laddu</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Tirumala Balaji Darshan</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Varahaswamy Temple, Tirumala</p>
                </div>
            </div>
            <div class="col">
                <div class="star" style="font-size: 17px;">
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Driver Batta, Andhra State Permit, Tollgate, Car Parking and Diesel charges &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Includes</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Covering 05 TEMPLES AND PLACES.</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Sri Anjaneyar Temple</p>
                </div>
            </div>
            <div class="col">
                <div class="star" style="font-size: 17px;">
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Tirupati Alamelumangapuram (Mahalakshmi Temple, Padmavathi Amman Temple)</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Balaji Face Rock</p>
                    <p><i class="fa fa-star"></i>&nbsp;&nbsp;Sri Varasiddi vinayaka Temple</p>
                </div>
            </div>
        </div>
    </div><br><br><br>

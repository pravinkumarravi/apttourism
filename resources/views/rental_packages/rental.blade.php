                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="rental.html">Rental Packages</a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="#">Rental Packages</a></h6>
                        <div class="product__item__price">₹ 5,000.00</div>
                        <div class="cart_add">
                            <a href="<?php echo url('rental_etios') ?>">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        ...
                        <div class="cart_add">
                            <a href="<?php echo url('rental_innova') ?>">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        ...
                        <div class="product__item__price">₹ 5,000.00</div>
                        <div class="cart_add">
                            <a href="<?php echo url('rental_swift') ?>">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        ...
                        <div class="cart_add">
                            <a href="<?php echo url('rental_tempo') ?>">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
